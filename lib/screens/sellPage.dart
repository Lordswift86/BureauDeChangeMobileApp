...
// multiplying rate by amount to get the total
  convertedRate() {
    var a = double.parse(dataPage.usdBuyRates);
    var b = double.parse(dataPage.gbpBuyRates);
    var c = double.parse(dataPage.eurBuyRates);
    var d = double.parse(dataPage.cadBuyRates);
